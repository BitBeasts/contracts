...
contract LendingGetterAndSetterFacet is Modifiers {
    ...
    ///@dev Only the bitbeast owner can set a lending operator
    ...
    ///@notice Get an bitbeast lending details through an identifier
    ...
    ///@notice Get an bitbeast lending details through an NFT
    ///@dev Will throw if the lending does not exist
    ...
    ///@notice Query a certain amount of bitbeast lending listings created by an address
    ...
    ///@notice Query a certain amount of bitbeast lending listings
    ///@param _status Status of the listings to query, "listed" or "agreed"
