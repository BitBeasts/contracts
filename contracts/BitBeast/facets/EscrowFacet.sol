...
contract EscrowFacet is Modifiers {
    ...
    ///@notice Allow the deposit of an ERC20 token to the escrow contract of a claimed bitbeast
    ///@dev Will throw if token being deposited is same as collateral token for the bitbeast
    ...
    ///@dev Will throw if one of the tokens being deposited is same as collateral token for the corresponding bitbeast
    ...
    ///@param _values An array containing the amounts of ERC20 tokens to deposit into each bitbeast
    ...
    ///@notice Query the balance of any ERC20 token being hekd in the escrow of an bitbeast
    ...
    ///@notice Allow the owner of the bitbeast to transfer out any ERC20 token in the escrow to an external address
