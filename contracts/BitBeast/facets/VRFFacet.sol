   ...
   |__________________________________*/
    ...
    function openPortals(uint256[] calldata _tokenIds) external {
        ...
        for (uint256 i; i < _tokenIds.length; i++) {
            ...
            require(owner == s.aavegotchis[tokenId].owner, "AavegotchiFacet: Only bitbeast owner can open a portal");
    ...
    ///@notice Allow the bitbeast diamond owner to change the vrf details
