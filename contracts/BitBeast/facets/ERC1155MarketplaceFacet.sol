...
contract ERC1155MarketplaceFacet is Modifiers {
    ...
    ///@notice Allow the bitbeast diamond owner or DAO to set the default listing fee
    ...
    ///@notice Allow the bitbeast diamond owner or DAO to set the category details for multiple ERC1155 NFTs
