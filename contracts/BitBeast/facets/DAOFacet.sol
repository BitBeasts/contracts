...
contract DAOFacet is Modifiers {
   ...
   |__________________________________*/
    ...
    ///@notice Allow the DAO, a game manager or the bitbeast diamond owner to grant XP(experience points) to multiple aavegotchis
    ///@dev recipients must be claimed aavegotchis
    ///@param _tokenIds The identifiers of the aavegotchis to grant XP to
    ///@param _xpValues The amount XP to grant each bitbeast
    ...
    ///@notice Allow the DAO, a game manager or the bitbeast diamond owner to remove XP(experience points) from multiple aavegotchis
    ///@dev recipients must be claimed aavegotchis
    ///@param _tokenIds The identifiers of the aavegotchis to grant XP to
    ///@param _xpValues The amount XP to grant each bitbeast
    ...
    ///@notice Allow the DAO or the bitbeast diamond owner to add new game managers and  their corresponding limits
    ...
    ///@notice Allow the DAO or the bitbeast diamond owner to remove existing  game managers
    ...
    ///@notice Allow the DAO or the bitbeast diamond owner to set the wearable slot position for a particular wearable
