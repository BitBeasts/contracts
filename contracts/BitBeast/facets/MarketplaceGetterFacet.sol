...
contract MarketplaceGetterFacet is Modifiers {
    ///@notice Get an bitbeast listing details through an identifier
    ...
    ///@return aavegotchiInfo_ A struct containing details about the bitbeast
    ...
    ///@param _category Category of listings to query // 0 == portal, 1 == vrf pending, 1 == open portal, 2 == BitBeast.
    ...
    ///@notice Query a certain amount of bitbeast listings created by an address based on their category and sortings
    ///@param _owner Creator of the listings to query
    ///@param _category Category of listings to query  // 0 == portal, 1 == vrf pending, 1 == open portal, 2 == BitBeast.
    ///@param _sort Sortings of listings to query // "listed" or "purchased"
    ///@param _length How many bitbeast listings to return
    ///@return listings_ An array of structs, each struct containing details about each listing being returned
    ...
    function getERC721Listings(
        uint256 _category, // 0 == portal, 1 == vrf pending, 1 == open portal, 2 == BitBeast.
    ...
    ///@notice Query a certain amount of bitbeast listings
    ///@param _category Category of listings to query // 0 == portal, 1 == vrf pending, 1 == open portal, 2 == BitBeast.
