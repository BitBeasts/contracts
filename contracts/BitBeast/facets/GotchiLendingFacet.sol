...
contract GotchiLendingFacet is Modifiers {
    ...
    ///@param _initialCost The lending fee of the bitbeast in $GHST
    ///@param _period The lending period of the bitbeast, unit: second
    ...
    ///@notice Allow an bitbeast lender (msg sender) or their lending operator to add request for lending
    ...
    ///@notice Allow an bitbeast lender or lending operator to cancel his NFT lending through the listingId
    ...
    ///@param _tokenId The identifier of the lent bitbeast to claim
    ...
    ///@notice Allow an bitbeast lender to cancel his NFT lending by providing the NFT contract address and identifier
