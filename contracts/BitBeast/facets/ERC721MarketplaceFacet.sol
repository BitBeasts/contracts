...
contract ERC721MarketplaceFacet is Modifiers {
    ...
    struct Category {
        address erc721TokenAddress;
        uint256 category; // 0,1,2,3 == BitBeast diamond, 4 == Realm diamond.
        // uint256 status; can add this in later if necessary
    }

    ///@notice Allow the bitbeast diamond owner or DAO to set the category details for different types of ERC721 NFTs
    ...
    ///@return category_ Category of the NFT // 0 == portal, 1 == vrf pending, 2 == open portal, 3 == BitBeast 4 == Realm.
    function getERC721Category(address _erc721TokenAddress, uint256 _erc721TokenId) public view returns (uint256 category_) {
        ...
        if (_erc721TokenAddress != address(this)) {
            ...
            category_ = s.aavegotchis[_erc721TokenId].status; // 0 == portal, 1 == vrf pending, 2 == open portal, 3 == BitBeast
        }
    }
