...
import {Modifiers, EQUIPPED_WEARABLE_SLOTS, BitBeast} from "../libraries/LibAppStorage.sol";
...
import "../../BitBeast/WearableDiamond/interfaces/IEventHandlerFacet.sol";
...
contract ItemsTransferFacet is Modifiers {
    ...
    */
    ...
    function extractItemsFromSacrificedGotchi(
        ...
        require(bitbeast.owner == address(0), "BitBeast has not been sacrificed");
