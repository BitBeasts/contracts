...
async function main () {
  ...
  let itemsFacet = (await ethers.getContractAt('contracts/BitBeast/facets/ItemsFacet.sol:ItemsFacet', diamondAddress)).connect(signer)
  let itemIds = [
    130, // fireball
    134, // L2 Sign
    137, // Vote sign
  ...
  // fireball
  // let bitbeast = await svgFacet.getAavegotchiSvg(4005)

  // vote
  let bitbeast = await svgFacet.getAavegotchiSvg(1412)
