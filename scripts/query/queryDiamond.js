...
async function main () {
  ...
  let diamond2
  diamond2 = await ethers.getContractAt('contracts/BitBeast/facets/ItemsFacet.sol:ItemsFacet', aavegotchiDiamondAddress)
  ...
  // diamond = await ethers.getContractAt('contracts/BitBeast/facets/AavegotchiFacet.sol:AavegotchiFacet', aavegotchiDiamondAddress)
  ...
  // const itemsFacet = await ethers.getContractAt('contracts/BitBeast/facets/ItemsFacet.sol:ItemsFacet', aavegotchiDiamondAddress)
  ...
  // diamond = await ethers.getContractAt('contracts/BitBeast/facets/ItemsFacet.sol:ItemsFacet', aavegotchiDiamondAddress)
