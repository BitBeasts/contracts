...
export async function upgrade1() {
  ...
  const facets: FacetsAndAddSelectors[] = [
    ...
    {
      facetName: "contracts/BitBeast/facets/BridgeFacet.sol:BridgeFacet",
      addSelectors: [],
      removeSelectors: [],
    },
    {
...
//also sets the address periphery address in the bitbeast diamond
export async function upgrade2() {
  ...
  const facets: FacetsAndAddSelectors[] = [
    ...
    {
      facetName: "contracts/BitBeast/facets/ItemsFacet.sol:ItemsFacet",
      addSelectors: [],
      removeSelectors: [
...
//This adds a new facet called WearableSetsFacet to the bitbeast diamond
