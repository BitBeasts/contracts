...
export async function upgradeAavegotchiForForge(forgeAddress: string) {
  console.log("Upgrading BitBeast facets for Forge.");
  ...
  const facets: FacetsAndAddSelectors[] = [
    {
      facetName:
        "contracts/BitBeast/facets/AavegotchiGameFacet.sol:AavegotchiGameFacet",
      addSelectors: [
    ...
    {
      facetName: "contracts/BitBeast/facets/DAOFacet.sol:DAOFacet",
      addSelectors: [
  ...
  console.log("Finished upgrading BitBeast facets for Forge.");
}
