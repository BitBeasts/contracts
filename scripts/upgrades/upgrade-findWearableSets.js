...
async function main () {
  ...
  const Facet = await ethers.getContractFactory('contracts/BitBeast/facets/ItemsFacet.sol:ItemsFacet')
  ...
  async function printSets (wearableIds) {
    facet = await ethers.getContractAt('contracts/BitBeast/facets/ItemsFacet.sol:ItemsFacet', diamondAddress)
