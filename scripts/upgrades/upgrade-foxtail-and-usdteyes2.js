...
async function main () {
  ...
  if (testing) {
    ...
    const aavegotchiFacet = await ethers.getContractAt('contracts/BitBeast/facets/AavegotchiFacet.sol:AavegotchiFacet', diamondAddress, signer)
    let itemsFacet = await ethers.getContractAt('contracts/BitBeast/facets/ItemsFacet.sol:ItemsFacet', diamondAddress, signer)
    ...
    // ustdt eye shape: https://bitbeast.com/gotchi/2687
