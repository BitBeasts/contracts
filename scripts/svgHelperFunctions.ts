...
import { aavegotchiSvgs } from "../svgs/bitbeast-side-typeScript";
import { aavegotchiSvgs as frontGotchiSvgs } from "../svgs/bitbeast-typescript";
import {
...
export async function aavegotchiUpdateForSvgTask(
  ...
  if ("front" === _side) {
    ...
    console.log(
      "Not a proper bitbeast side, must be string of front, left, right or back ONLY"
    );
  }
}
