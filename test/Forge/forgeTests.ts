...
// See contracts/BitBeast/ForgeDiamond/libraries/LibAppStorage.sol
...
describe("Testing Forge", async function () {
    ...
    before(async function (){
        ...
        forgeFacet = (await ethers.getContractAt(
            "contracts/BitBeast/ForgeDiamond/facets/ForgeFacet.sol:ForgeFacet",
            forgeDiamondAddress
        )) as ForgeFacet;
        forgeDaoFacet = (await ethers.getContractAt(
            "contracts/BitBeast/ForgeDiamond/facets/ForgeDAOFacet.sol:ForgeDAOFacet",
            forgeDiamondAddress
        )) as ForgeDAOFacet;
        forgeTokenFacet = (await ethers.getContractAt(
            "contracts/BitBeast/ForgeDiamond/facets/ForgeTokenFacet.sol:ForgeTokenFacet",
            forgeDiamondAddress
        )) as ForgeTokenFacet;
        // forgeVrfFacet = (await ethers.getContractAt(
        //     "contracts/BitBeast/ForgeDiamond/facets/ForgeVRFFacet.sol:ForgeVRFFacet",
        //     forgeDiamondAddress
        // )) as ForgeVRFFacet;
        aavegotchiFacet = (await ethers.getContractAt(
            "contracts/BitBeast/facets/AavegotchiFacet.sol:AavegotchiFacet",
            maticDiamondAddress
        )) as AavegotchiFacet;
        wearablesFacet = (await ethers.getContractAt(
            "contracts/BitBeast/WearableDiamond/facets/WearablesFacet.sol:WearablesFacet",
            WEARABLE_DIAMOND
        )) as WearablesFacet;
        collateralFacet = (await ethers.getContractAt(
            "contracts/BitBeast/facets/CollateralFacet.sol:CollateralFacet",
            maticDiamondAddress
        )) as CollateralFacet;
        itemsFacet = (await ethers.getContractAt(
            "contracts/BitBeast/facets/ItemsFacet.sol:ItemsFacet",
            maticDiamondAddress
        )) as ItemsFacet;
        aavegotchiDaoFacet = (await ethers.getContractAt(
            "contracts/BitBeast/facets/DAOFacet.sol:DAOFacet",
            maticDiamondAddress
        )) as DAOFacet;
        lendingFacet = (await ethers.getContractAt(
            "contracts/BitBeast/facets/GotchiLendingFacet.sol:GotchiLendingFacet",
            maticDiamondAddress
        )) as GotchiLendingFacet;
        lendingGetSetFacet = (await ethers.getContractAt(
            "contracts/BitBeast/facets/LendingGetterAndSetterFacet.sol:LendingGetterAndSetterFacet",
            maticDiamondAddress
    ...
    describe("smelt forge flow", async function (){
        ...
        it('should test essence and forge queue', async function () {
            ...
            await expect(impForgeFelon.forgeWearables([17], [19095], [0])).to.be.revertedWith("ForgeFacet: BitBeast already forging")
        ...
        it('should use gltr to speed up actions', async function () {
            ...
            await expect(impForgeFelon.forgeWearables([78], [11866], [0]))
                .to.be.revertedWith("ForgeFacet: BitBeast already forging")
    ...
    describe("revert tests", async function (){
        ...
        it('should revert smelt correctly', async function () {
            ...
            // await expect(imp.smeltWearables([157], [2270])).to.be.revertedWith("ForgeFacet: BitBeast is locked")
            await expect(imp.smeltWearables([157], [1])).to.be.revertedWith("ForgeFacet: Not BitBeast owner")
        ...
        it('should revert for rental gotchi', async function () {
            ...
            await expect(impTestForge.claimForgeQueueItems([7735])).to.be.revertedWith("ForgeFacet: BitBeast is lent out")
            await expect(impRenterForge.claimForgeQueueItems([7735])).to.be.revertedWith("ForgeFacet: BitBeast is lent out")
