...
interface AragonFundraisingControllerInterface extends ethers.utils.Interface {
  functions: {
...
export class AragonFundraisingController extends BaseContract {
  ...
  interface: AragonFundraisingControllerInterface;
