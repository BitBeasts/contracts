...
interface AavegotchiGameFacetInterface extends ethers.utils.Interface {
  functions: {
    ...
    "isAavegotchiLocked(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "isAavegotchiLocked",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class AavegotchiGameFacet extends BaseContract {
  ...
  functions: {
    ...
    tokenIdsWithKinship(
      ...
      [
        ...
        tokenIdsWithKinship_: ([BigNumber, BigNumber, BigNumber] & {
          tokenId: BigNumber;
          kinship: BigNumber;
          lastInteracted: BigNumber;
        })[];
  ...
  callStatic: {
    ...
    setRealmAddress(_realm: string, overrides?: CallOverrides): Promise<void>;
