...
export type ChangeSupportRequiredEvent = TypedEvent<
  [BigNumber] & { supportRequiredPct: BigNumber }
>;

export type ChangeMinQuorumEvent = TypedEvent<
  [BigNumber] & { minAcceptQuorumPct: BigNumber }
>;
...
export class Voting extends BaseContract {
  ...
  filters: {
    ...
    "ExecuteVote(uint256)"(
      voteId?: BigNumberish | null
    ): TypedEventFilter<[BigNumber], { voteId: BigNumber }>;
    ...
    ): TypedEventFilter<[BigNumber], { supportRequiredPct: BigNumber }>;
    ...
    ): TypedEventFilter<[BigNumber], { minAcceptQuorumPct: BigNumber }>;
