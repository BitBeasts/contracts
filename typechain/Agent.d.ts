...
export type SafeExecuteEvent = TypedEvent<
  [string, string, string] & { sender: string; target: string; data: string }
>;
...
export type AddProtectedTokenEvent = TypedEvent<[string] & { token: string }>;
...
export type PresignHashEvent = TypedEvent<
  [string, string] & { sender: string; hash: string }
>;
